...
<body style="background-color: #999999;">
	...
	$query = mysqli_query($db, "SELECT * FROM employee WHERE email='{$email}'");
     ...
     while($row = mysqli_fetch_array($query))
   {
	...
	mysqli_query($db, "UPDATE employee SET emp_name ='$name',email ='$mail',contact_no ='$contact' WHERE emp_id='{$id}' ");
		...
		echo 'alert("Your account details were updated. Please login again!")';
		echo'</script>';			
  ...
  ?>
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form"  method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Center_ID</span>
						<input class="input100" type="text" name="center_id" placeholder="Name..." onFocus="this.value=''" value="<?php if ($update==true ) {echo $center;} else{echo "";}?>" disabled>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						...
						<input class="input100" type="text" name="user_type" placeholder="Name..." onFocus="this.value=''" value="<?php if ($update==true ) {echo $user;} else{echo "";}?>" disabled>
						<span class="focus-input100"></span>
					</div>
