        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM ((vehicles INNER JOIN operational_centers ON vehicles.center_id = operational_centers.center_id) INNER JOIN employee ON vehicles.emp_id = employee.emp_id)";
