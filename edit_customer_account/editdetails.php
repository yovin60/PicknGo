...
<body style="background-color: #999999;">
     ...
     while($row = mysqli_fetch_array($query))
   {
	...
	mysqli_query($db, "UPDATE customer SET cus_name ='$name', address='$address', contact_no ='$contact', email ='$mail' WHERE cus_id='{$id}' ");
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form"  method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Cus_ID</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						...
						<input class="input100" type="text" name="addr" placeholder="Name..." onFocus="this.value=''" value="<?php if ($update==true ) {echo $address;} else{echo "";}?>">
						<span class="focus-input100"></span>
					</div>
