...
if(isset($_POST['continue']) && $_POST['email'])
{
  ...
  $eml=$_POST['email'];
  $select=mysql_query("select email,password from admin where email='{$eml}'");
  if(mysql_num_rows($select)==1)
  {
    ...
    $link="<a href='http://localhost/PicknGo/admin_password_reset/reset_pass.php?key=".$email."&reset=".$pass."'>Click To Reset password</a>";
