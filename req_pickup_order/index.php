            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">My Pending Orders</h2>
                    ...
                    $sql = "SELECT * FROM pickup_orders INNER JOIN customer ON pickup_orders.cus_id = customer.cus_id WHERE pickup_orders.cus_id = '{$cus}' && status = 'PENDING'";
